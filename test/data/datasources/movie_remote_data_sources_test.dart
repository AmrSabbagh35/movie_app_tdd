...
import 'package:movie_app/movies/data/datasources/remote/movie_remote_data_source_impl.dart';

import 'movie_remote_data_sources_test.mocks.dart';
...
void main() {
  ...
  const tUrl =
      'https://api.themoviedb.org/3/trending/movie/day?api_key=f47d39a4ec12ecae1c6f318b061e3e1f';
  const pUrl =
      'https://api.themoviedb.org/3/movie/popular?api_key=f47d39a4ec12ecae1c6f318b061e3e1f';
  const sUrl =
      'https://api.themoviedb.org/3/search/movie?query=$tQuery&api_key=f47d39a4ec12ecae1c6f318b061e3e1f';
